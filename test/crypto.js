...
describe('Crypto', () => {
  it('should derive publicKey from privateKey', async () => {
    ...
    const publicKey1 = '0x37f91e6ec022b55c08eca29f89e47f6f03ad1af35d3a7b2cacd1514c0c9e31c0358a181b3d50552440a9b1c7ea2942b94b178179a16798bcd7fc77b1cccff309';
    const privateKey1 = '0x7cbb15a540c3954792bf3729f9b26c0242e745890332bcf2ffeaece345f9d141';
  ...
  it('should calculate shared secret', async () => {
    const ss1 = 'cf94abf3d2ac14aeff10c407c5f7c8cc935f27e8da85a8d85f0a4802e4107ffa';
    const privateKey1 = '0x7cbb15a540c3954792bf3729f9b26c0242e745890332bcf2ffeaece345f9d141';
    const publicKey1 = '04a621164c25da8bb0d87652c0c24d946dc4793f45609fd6006e23e6255646bb32d60af2800b1492aa8d8927c6904f2acab727637c072dbce786a5cd36f18cff86';
    ...
    const css3 = crypto.calculateSharedSecret(w1.wallet.privateKey, w2.wallet.publicKey);
    const css4 = crypto.calculateSharedSecret(w2.wallet.privateKey, w1.wallet.publicKey);
